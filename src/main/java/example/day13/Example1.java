...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        //* 제네릭< > : 인스턴스(객체) 생성시 인스턴스(객체)내 멤버들의 타입 정의
        //[4-1] Function< T,R> : T:입력 받아서 R:결과를 반환
        ...
        Predicate< Integer > predicate = x -> x%2 == 0; // 짝수이면 true, 아니면 false
        System.out.println("[7] predicate : " + predicate.test(3));

        //forEach 는 return 이 없으니깐 소비만 하는.. forEach 의 부모 ,
        // map같은경우는 function를 하고 , filter 조건문이 들어가니깐 predicate 사용
