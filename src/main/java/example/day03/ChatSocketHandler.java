...
public class ChatSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        if( msg.get("type").equals("join")){
            ...
            session.getAttributes().put("room", room);          // 브라우저세션 vs HTTP세션 vs 웹소켓 세션
    ...
    public void alarmMessage(String room, String message) throws Exception{
        ...
        // 4-2 : map 타입을 JSON 형식의 문자열타입으로 변환, objectMapper
