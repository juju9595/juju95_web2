...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //2. UsernamePasswordAuthenticationToken 을 내 재정의하기
...
//                    new UsernamePasswordAuthenticationToken("id", "pasword", "권한");
//            new UsernamePasswordAuthenticationToken(
//                    id, password,
//                    List.of(new SimpleGrantedAuthority("ROLE_XXX"), new SimpleGrantedAuthority("ROLE_XXX")));
            // 2-2 : 시큐리티 토큰 생성
        ...
        // 3 : 다른 필터에서 해당하는 토큰필터를 호출 할 수 있도록
