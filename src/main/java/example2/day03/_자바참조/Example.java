...
public class Example {
    public static void main(String[] args) {
        ...
        board1.setCategory(category1);//** 1번 게시물에 1번 공지사항 참조한다**//
        ...
        // *toString() 함수란? 객체 호출시 참조주소값 대신에 내용물을 출력하는 함수
        // 즉] 인천광역시 부평구 xxx동 101호 -->
