...
public interface TodoRepository
    ...
    // *+++ JPA Repository
    // 1. save(), 2. findById(), 3. findAll() 4.deleteBody() 등등 미리 만들어진 CRUD 제공한다.
    ...
    // 2-3 : findBy필드명TitleContaining <--> select * from where title like %매개변수%;
    ...
    //3. 네이티브 쿼리 메소드
    // *SQL 문장을 직접 작성하여 실행한다. , : (클론)매개변수명 이용하여 매개변수 값 대입한다.
    // 3-1 : @Query(value = "SQL 작성", nativeQuery = true) 추상메소드에 주입한다.
