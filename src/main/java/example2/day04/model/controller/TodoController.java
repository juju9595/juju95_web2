...
@CrossOrigin(value = "*") // 리액트/프럴터 CORS 허용
public class TodoController {
    ...
    @GetMapping("/query2")
    public ResponseEntity<?> query2(@RequestParam String title, @RequestParam String content){return ResponseEntity.ok(todoService.query2(title, content));
    }
