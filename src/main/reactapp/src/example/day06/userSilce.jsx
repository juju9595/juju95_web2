...
//[1] 리덕스 설치 : reactapp 폴더 오른쪽 클릭 ---> 터미널 열기
...
//[3] 상태를 변경하는 리듀서 함술들을 정의
// createSlice ({name : 'slice이름', 초기값, 리듀서 : rducers : {액션함수 : (state)=>{}}});
...
//[4] 내보내기
//[4-1] export default 내보내기는 파일내 1개만 가능 , store 에 리듀서를 improt 할 수 있게
export default userSilce.reducer 
//[4-2] export 내보내기는 여러번 가능
export const { login, logout } = userSilce.actions; //login액션, logout액션을 다른 컴포넌트에 import 할 수 있게