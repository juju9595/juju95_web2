...
const obj = {name : "유재석"};  // 변수/상수 에는 객체/함수/배열 를 담기 가능
...
//[3-2] 조건문2 : 삼항연산자 , 조건 ? 참 : 거짓 , 간단한조건에서 주로 사용됨
console.log( point >=90 ? "A학점" : point >=80 ? "B학점" : "C학점");

//[3-3] 조건3 : 단축평가 , 조건 && 참이면결과, 조건 || 거짓이면결과
console.log(point >= 90 && "A학점"); // 만약에 참이면 'A학점' 아니면 false
console.log(point >= 90 || "A학점"); // 만약에 참이면 true 이면 "A학점"
...
const fun3 = ( param1, parma2 ) => {} // 5-3 화살표 함수 선언
...
console.log(obj3[0]);
// *** 스프레드 연산자 : ... : 배열이나 객체를 복사할때 사용 ,  왜? 주소값 변경목적
...
//[9] async/await 동기화
    //1. 비동기, fetch , fetch 함수는 원래 비동기 레퍼(new Promise) 이다.
const method1 = () => {
...
const method2 = async() =>{
    ...
    //******* Promise : await은 promise 을 사용하는 함수들에 적용된다.*******
